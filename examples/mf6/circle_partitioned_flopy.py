...
cbc = imod.mf6.open_cbc(ip_unsplit_dir/"GWF_1/GWF_1.cbc",ip_unsplit_dir/ "GWF_1/disv.disv.grb")
...
q1 = imod.mf6.open_cbc(ip_unsplit_dir/"GWF_1/GWF_1_0.cbc",flopy_split_dir/ "gwf_1_0.disv.grb")
q2 = imod.mf6.open_cbc(ip_unsplit_dir/"GWF_1/GWF_1_1.cbc",flopy_split_dir/ "gwf_1_1.disv.grb")
...
assert np.testing.assert_allclose(original_balances["npf-qx" ].values, balances["npf-qx"].values, equal_nan=True)
pass
