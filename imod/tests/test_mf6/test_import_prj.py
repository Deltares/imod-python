...
0001,(KHV),1, Horizontal Permeability
001,2
1,1,1,0.0,0.0,2.0   >>> (KHV) Horizontal Permeability (IDF) <<<
1,2,2,2.0,0.0,-999.99, '.\Database\KHV\VERSION_1\IPEST_KHV_L2.IDF' >>> (KHV) Horizontal Permeability (IDF) <<<
""",
)
