...
def test_mf6_ybrahim(tmp_path):
    prj_dir = Path("D:\\dev\\imod_python-gh\\vanFrans\\e400_iMOD5\\f03_regional_tests\\c02_Ibrahym_01")
    data = open_projectfile_data(
        prj_dir / "c02_Ibrahym_01__root__.prj"
    )
...
def test_mf6_khazad_dum(tmp_path):
    prj_dir = Path("D:\\dev\\imod_python-gh\\vanFrans\\e400_iMOD5\\f03_regional_tests\\c04_Moria_01")
    data = open_projectfile_data(
        prj_dir / "c04_Moria_01__root__.PRJ"
    )
...
def test_mf6_tut(tmp_path):
    prj_dir = Path("D:\\dev\\imod_python-gh\\vanFrans\\e400_iMOD5\\f02_tutorial_tests\\c05_TUT_iMODBatch")
    data = open_projectfile_data(
        prj_dir / "c05_TUT_iMODBatch_T2__root__.prj"
    )
