...
import numpy as np
import xarray as xr
from examples.mf6.example_models import create_hondsrug_simulation, create_circle_simulation, create_twri_simulation

import imod
from imod.typing import GridDataArray

def test_hondsrug_regrid(tmp_path):
    # %%
    ...
    original_modeldir = tmp_path / "original"
    gwf_simulation.write(original_modeldir, binary=False)
    # gwf_simulation.run()
