...
def test_alternative_constructor(naardermeer, ijsselmeer):
    ...
    reslt =actual.render(None, None, None, False)
...
def test_lake_write(tmp_path, naardermeer, ijsselmeer):
    ...
    expected = textwrap.dedent(
        ...
        2 4 1 5 5 horizontal 0.2 0.4 0.3 0.6 0.5
        2 5 1 5 6 horizontal 0.2 0.4 0.3 0.6 0.5
        2 6 1 6 6 horizontal 0.2 0.4 0.3 0.6 0.5
        end connectiondata
...
def test_lake_write_disv_three_lakes(basic_dis, tmp_path):
    ...
    expected = textwrap.dedent(
        ...
        2 4 1 17 horizontal -1.0 -4.0 0.2 -4.0 -4.0
