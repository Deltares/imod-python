...
def well_regular_import_data():
    ...
    return write_files(projectfile_str, ipf1_str, ipf2_str,timeseries_well_str,tmp_path )
...
def well_duplication_import_data():
    ...
    return write_files(projectfile_str, ipf1_str, ipf2_str,timeseries_well_str,tmp_path ,other_timeseries_well_str )