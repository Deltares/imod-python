...
class _LoggerHolder(ILogger):
    ...
    This makes it less critical when the logger is being configured. For instance, without
    ...
    This wrapper solves this issue. During initialization time this Holder is returned,
