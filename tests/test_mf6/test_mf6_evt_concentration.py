...
def test_render(concentration_fc, elevation_fc, conductance_fc, ):
    directory = pathlib.Path("mymodel")
    globaltimes = [np.datetime64("2000-01-01"),np.datetime64("2000-01-02"),np.datetime64("2000-01-03")]

    drn = imod.mf6.Drainage(elevation=elevation_fc, conductance=conductance_fc,boundary_concentration =concentration_fc, transport_boundary_type="AUX")
