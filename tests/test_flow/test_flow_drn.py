...
def drain(basic_dis, three_days):
...
def test_drain(get_render_dict, drain, three_days):
    ...
    to_render = get_render_dict(drain, directory, times, nlayer)
